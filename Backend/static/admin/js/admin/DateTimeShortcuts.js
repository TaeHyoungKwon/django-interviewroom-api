...
(function() {
  ...
  var DateTimeShortcuts = {
    ...
    clockHours: {
      default_: [
        [gettext_noop('Now'), -1],
        [gettext_noop('09:00 AM'), 9, 0],
        [gettext_noop('09:30 AM'), 9, 30],
        [gettext_noop('10:00 AM'), 10, 0],
        [gettext_noop('10:30 AM'), 10, 30],
        [gettext_noop('11:00 AM'), 11, 0],
        [gettext_noop('11:30 AM'), 11, 30],
        [gettext_noop('12:00 AM'), 12, 0],
        [gettext_noop('12:30 AM'), 12, 30],
        [gettext_noop('13:00 PM'), 13, 0],
        [gettext_noop('13:30 PM'), 13, 30],
        [gettext_noop('14:00 PM'), 14, 0],
        [gettext_noop('14:30 PM'), 14, 30],
        [gettext_noop('15:00 PM'), 15, 0],
        [gettext_noop('15:30 PM'), 15, 30],
        [gettext_noop('16:00 PM'), 16, 0],
        [gettext_noop('16:30 PM'), 16, 30],
        [gettext_noop('17:00 PM'), 17, 0],
        [gettext_noop('17:30 PM'), 17, 30],
        [gettext_noop('18:00 PM'), 18, 0]
      ]
    },
    dismissClockFunc: [],
    dismissCalendarFunc: [],
    ...
    addClock: function(inp) {
      ...
      DateTimeShortcuts.clockHours[name].forEach(function(element) {
        ...
        time_link.addEventListener('click', function(e) {
          e.preventDefault();
          DateTimeShortcuts.handleClockQuicklink(num, element[1], element[2]);
        });
      });
    ...
    handleClockQuicklink: function(num, val, minutes) {
      var d;
      if (val === -1) {
        d = DateTimeShortcuts.now();
      } else {
        d = new Date(1970, 1, 1, val, minutes, 0, 0);
      }
      DateTimeShortcuts.clockInputs[num].value = d.strftime(
        get_format('TIME_INPUT_FORMATS')[2]
      );
